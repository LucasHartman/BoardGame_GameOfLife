...
public class newGameSheet {

	// Test Data ==========================================================
	// A bunch of values to input to the xml generator, for testing purposes
	// =====================================================================
	...
	public static void createPsheet(String player1, String player2,String player3,String player4, 
									String playerCount, 
									String player1Longitude, String player2Longitude, String player3Longitude, String player4Longitude) {

		
		String[] playerNames = { player1, player2, player3, player4 };
		String[] playerStates = { "false", "false","false","false" };
		String[] playerLongitude = { player1Longitude, player2Longitude, player3Longitude, player4Longitude };
		...
		try {
			...
			for(int i=0; i<=3; i++) {
				...
				Element player = doc.createElement("player");
						...
						longitudeY.setTextContent(playerLongitude[i]);	
			...
			// =====================================================================
				...
				Element globals = doc.createElement("globals");
					...
					playerNumber.setTextContent(playerCount);	
